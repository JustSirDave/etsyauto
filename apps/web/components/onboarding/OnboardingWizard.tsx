...
function AIGenerateStep({ onNext, onBack }: { onNext: () => void; onBack: () => void }) {
  ...
  return (
    <div className="text-center py-8">
      ...
      <h3 className="text-xl font-semibold mb-4">Generate AI Content</h3>
      <p className="text-gray-600 mb-8">
        Let AI create optimized titles, descriptions, and tags for your products
      </p>
      ...
      <div className="flex justify-between mt-8">
        ...
        <button
          ...
          className="flex items-center bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50"
        >
          {generating ? 'Generating...' : 'Generate & Continue'}
          <ArrowRightIcon className="w-4 h-4 ml-2" />
        </button>
      </div>
    </div>
